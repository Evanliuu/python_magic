...
class Machine_handle(object):
            ...
            try:
                ...
                for index, line in enumerate(config_mapping_check_cmd):
                    ...
                    if len(config_mappings) > 1:
                        collection_info['Multiple_config_mapping'] = 'Yes'
                    else:
                        collection_info['Multiple_config_mapping'] = 'No'
    ...
    def main(self):
        ...
        if self.result_info:
            ...
            csv_header = ['Product_line', 'Mapping_check_result', 'Total_config_mapping', 'Multiple_config_mapping',
